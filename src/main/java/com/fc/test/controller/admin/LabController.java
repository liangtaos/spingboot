...
@Controller
@RequestMapping("LabController")
@Api(value = "用户数据")
public class LabController extends BaseController{
	
	private String prefix = "admin/lab";
	
	
	@GetMapping("view")
	@RequiresPermissions("system:lab:view")
    public String view(Model model)
    {	
		
		setTitle(model, new TitleVo("实验室列表", "实验室管理", true,"实验室管理页面", true, false));
        return prefix + "/list";
    }
	...
	@PostMapping("list")
	@RequiresPermissions("system:lab:list")
	@ResponseBody
